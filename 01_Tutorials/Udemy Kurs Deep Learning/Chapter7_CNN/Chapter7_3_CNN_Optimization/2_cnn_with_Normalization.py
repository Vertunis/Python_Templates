# In dieser Datei wird die Normalsierung in mnistData_Preprocessing.py aktiviert
...
MODEL_LOG_DIR = os.path.join(LOGS_DIR, "mnist_7_3_cnn2")  # Muss einzigartiger name sein
