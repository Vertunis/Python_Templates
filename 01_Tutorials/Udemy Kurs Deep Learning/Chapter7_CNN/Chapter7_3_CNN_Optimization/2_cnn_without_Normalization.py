# In dieser Datei wird die Normalsierung in mnistData_Preprocessing.py deaktiviert
# https://www.udemy.com/course/deep-learning-grundlagen-neuronale-netzwerke-mit-tensorflow/learn/lecture/18435572#overview
...
MODELS_FILE_PATH = os.path.join(MODELS_DIR, "mnist_7_3_cnn1.h5")  # h5 Datei wird von Keras zum speichern der Gewichte verwendet

if not os.path.exists(MODELS_DIR):
    os.mkdir(MODELS_DIR)

LOGS_DIR = os.path.abspath(r"M:\Google Drive\Programming\Python\01_Tutorials\Udemy Kurs Deep Learning\logs")
MODEL_LOG_DIR = os.path.join(LOGS_DIR, "mnist_7_3_cnn1")  # Muss einzigartiger name sein
