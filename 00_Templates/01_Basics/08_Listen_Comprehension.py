...
matrix = [[1, 0],[2, 3],[4, 5]]
print(matrix)
matrix = [[0 for j in range(3)] for i in range (3)] # 3x3 Matrix: [[<Zeile>]<Spalte>] mit allen Werten == 0
print(matrix)

matrix = [[i * j for j in range(3)] for i in range (3)] # 3x3 Matrix: [[<Zeile>]<Spalte>]: Z1: i=0,j=0,1,2    Z2: i=1 j=0,1,2     Z3: i=2 j=0,1,2
print(matrix)